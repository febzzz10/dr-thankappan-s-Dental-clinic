    ...
    <phantom-ui loading={loading}>
      <GradientBackground gradients={dentalSoftGradients} animationDuration={10} overlay={false} className="min-h-screen">
        ...
        <Container className="pt-0 pb-16 md:pt-0 md:pb-24">
          ...
          >
            <h2 className="font-display text-fluid-h2 font-bold text-center text-slate-900">
              Common Questions About Our Dental Services
            </h2>
            <div className="mt-8 space-y-4">
              {[
                { q: 'Is root canal treatment painful?', a: 'No, modern root canal treatment is done under local anesthesia. Most patients say it feels no different than getting a regular filling.' },
                { q: 'How long does dental implant treatment take?', a: 'The complete implant process typically takes 3-6 months, including healing time. The implant placement itself takes about 1 hour.' },
                { q: 'Do you accept insurance?', a: 'Please contact our clinic directly to discuss insurance coverage and payment options.' },
                { q: 'How often should I get my teeth cleaned?', a: 'We recommend professional cleaning and check-up every 6 months to maintain optimal oral health.' },
              ].map((faq) => (
                <details key={faq.q} className="group rounded-2xl border border-slate-100 bg-white p-5 shadow-sm open:shadow-md transition-shadow">
