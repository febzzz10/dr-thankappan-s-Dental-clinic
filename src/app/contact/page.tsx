        ...
        <div className="grid gap-12 grid-cols-[repeat(auto-fit,minmax(min(100%,24rem),1fr))]">
          ...
          >
            <div className="space-y-6">
              {[
                { icon: PiMapPin, title: 'Address', content: settings.clinic_address, href: null },
                { icon: PiPhone, title: 'Phone', content: settings.clinic_phone, href: `tel:${settings.clinic_phone}` },
                { icon: PiEnvelope, title: 'Email', content: settings.clinic_email, href: `mailto:${settings.clinic_email}` },
              ].map((item) => {
