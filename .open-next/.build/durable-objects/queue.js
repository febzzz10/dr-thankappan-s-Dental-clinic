...
// node_modules/.pnpm/@opennextjs+cloudflare@1.19_8d76f118353887c4d70aa871050eed01/node_modules/@opennextjs/cloudflare/dist/api/durable-objects/queue.js
...
var DOQueueHandler = class extends DurableObject {
    ...
    try {
      ...
      response = await this.service.fetch(`${protocol}://${host}${url}`, {
        ...
        headers: {
          ...
          "x-prerender-revalidate": "83e82c2c5d1a67185b9857f0a4bb2949",
          "x-isr": "1"
        },
  ...
  async addToFailedState(msg) {
    ...
    if (!this.disableSQLite) {
      this.sql.exec("INSERT OR REPLACE INTO failed_state (id, data, buildId) VALUES (?, ?, ?)", msg.MessageDeduplicationId, JSON.stringify(updatedFailedState), "jHSSb1YfEkOEGCHIwrQ7Y");
    }
    await this.addAlarm();
  }
  async addAlarm() {
  ...
  async initState() {
    ...
    this.sql.exec("DELETE FROM failed_state WHERE buildId != ?", "jHSSb1YfEkOEGCHIwrQ7Y");
    this.sql.exec("DELETE FROM sync WHERE buildId != ?", "jHSSb1YfEkOEGCHIwrQ7Y");
